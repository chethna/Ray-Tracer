...
public:
	...
	Sphere(Vector3d, double, Color,string,string, char,float RI);
	...
	Sphere::Sphere(Vector3d centerValue, double radiusValue, Color colorValue,string texFileNameValue, string normalTexFileNameValue,char materialChar,float RI){
		center = centerValue;
		radius = radiusValue;
		color = colorValue;
