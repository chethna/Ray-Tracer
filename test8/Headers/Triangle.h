...
public:
	...
	Triangle(Vector3d,Vector3d,Vector3d,Color colorValue, char materialChar,float RI);
	
	Triangle(Vector3d,Vector3d,Vector3d,Color, char, string, PixMapValues,Vector3d,Vector3d,Vector3d,float RI);
	...
	Triangle::Triangle(Vector3d point1, Vector3d point2, Vector3d point3, Color colorValue, char materialChar,float RI){
		p1 = point1;
		p2 = point2;
		p3 = point3;
		Vector3d a = (p2-p1);
...
Triangle::Triangle(Vector3d point1, Vector3d point2, Vector3d point3, Color colorValue, char materialChar, string fileNameValue, PixMapValues value,Vector3d tx1,Vector3d tx2,Vector3d tx3,float RI){
